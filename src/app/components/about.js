...
const About = () => {
  return (
   ...
   <div className='relative w-full h-fit'>
      ...
      <div className='w-full xl:h-[60vh] lg:h-[50vh] px-20 overflow-hidden bg-[#1b1108]  relative'>
      ...
      <div className='px-20  bg-[#ebd3ac] py-10 flex jsucetify-centre items-center '>
        ...
        <img className='lg:w-[70%] 2xl:w-[80%] rounded-xl' src="/about/founder.jpg" alt="" />
        </div>
      ...
      <div className='px-20  bg-[#ebd3ac] py-10 flex jsucetify-centre items-center '>
        ...
        <motion.div
             ...
             >
        <div className='w-full flex justify-center items-center'>
          <img className='lg:w-[70%] 2xl:w-[80%] rounded-xl' src="/about/cafe.jpg" alt="" />
        </div>
        </motion.div> 
...
<div className='px-20  bg-[#ebd3ac] py-10 flex jsucetify-centre items-center '>
       <motion.div
        ...
        <img className='lg:w-[70%] 2xl:w-[80%] rounded-xl' src="/about/latte2.jpg" alt="" />
        </div>
          </motion.div>
      </div>
 ...
 <div className='px-20  bg-[#ebd3ac] py-10 flex jsucetify-centre items-center '>
        ...
        <motion.div
             ...
             >
        <div className='w-full flex justify-center items-center'>
          <img className='lg:w-[70%] 2xl:w-[80%] rounded-xl' src="/about/ourSpace.jpg" alt="" />
        </div>
        </motion.div> 
