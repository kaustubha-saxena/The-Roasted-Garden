...
const Navbar = () => {
  return (
    <>
      <nav className=' absolute top-0 w-[100vw] h-15  flex justify-between items-center px-10 after:content-[""] after:w-full after:h-[2px]  after:absolute after:bottom-0 after:left-0 z-99  bg-[#1b1108]'>
        <div className="logo">
        ...
        <ul className='flex justify-center items-center gap-4 text-[#6e6e6e] text-white font-semibold  text-sm '>
          ...
          <li ><Link href={"/find-us"}><button className='text-black px-3 py-1 rounded-lg bg-amber-400 font-medium  '>Find Us</button></Link></li>
