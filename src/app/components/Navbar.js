  ...
  return (
    <>
      <nav className=' sticky top-0 w-[100%] h-15  flex  justify-between items-center px-10  after:content-[""] after:w-full after:h-[2px]  after:absolute after:bottom-0 after:left-0 z-99  bg-[#1b1108] '>
        <div className="logo">
          <Link href={"/"} >
            <h3 className='text-[#dadada] font-extrabold 2xl:text-2xl xl:text-xl lg:text-lg'>The Roasted Garden</h3>
          </Link>
        </div>
        <ul className='flex justify-center items-center gap-4 text-[#bcbcbc] font-semibold 2xl:text-base xl:text-base lg:text-sm '>
          ...
          <li ><Link href={"/findus"}>
            <button className='px-4 bg-[#f3d3a1] 2xl:py-2 lg:py-1  hover:cursor-pointer hover:bg-[#dec59b] shadow-sm shadow-[#cca361] text-black font-bold'>Find Us</button>
          </Link></li>
